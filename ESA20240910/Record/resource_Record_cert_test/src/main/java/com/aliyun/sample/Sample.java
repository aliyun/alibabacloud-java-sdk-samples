...
public class Sample {
    ...
    public static PurchaseRatePlanResponseBody ratePlanInstCert(com.aliyun.esa20240910.Client client) throws Exception {
    ...
    public static CreateSiteResponseBody siteCert(PurchaseRatePlanResponseBody ratePlanInstCertResponseBody, com.aliyun.esa20240910.Client client) throws Exception {
        ...
        CreateSiteRequest createSiteRequest = new CreateSiteRequest()
                ...
                .setInstanceId(ratePlanInstCertResponseBody.instanceId)
                .setCoverage("overseas")
                .setAccessType("NS");
    ...
    public static CreateRecordResponseBody recordCert(CreateSiteResponseBody siteCertResponseBody, com.aliyun.esa20240910.Client client) throws Exception {
    ...
    public static void updateRecordCert(CreateRecordResponseBody createRecordResponseBody, com.aliyun.esa20240910.Client client) throws Exception {
    ...
    public static void destroyRecordCert(CreateRecordResponseBody createRecordResponseBody, com.aliyun.esa20240910.Client client) throws Exception {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Init resource
        PurchaseRatePlanResponseBody ratePlanInstCertRespBody = Sample.ratePlanInstCert(esa20240910Client);
        CreateSiteResponseBody siteCertRespBody = Sample.siteCert(ratePlanInstCertRespBody, esa20240910Client);
        CreateRecordResponseBody recordCertRespBody = Sample.recordCert(siteCertRespBody, esa20240910Client);
        // update resource
        Sample.updateRecordCert(recordCertRespBody, esa20240910Client);
        // destroy resource
        Sample.destroyRecordCert(recordCertRespBody, esa20240910Client);
    }
}
