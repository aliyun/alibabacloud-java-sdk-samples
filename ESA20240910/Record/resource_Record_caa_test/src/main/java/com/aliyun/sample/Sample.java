...
public class Sample {
    ...
    public static PurchaseRatePlanResponseBody ratePlanInstCaa(com.aliyun.esa20240910.Client client) throws Exception {
    ...
    public static CreateSiteResponseBody siteCaa(PurchaseRatePlanResponseBody ratePlanInstCaaResponseBody, com.aliyun.esa20240910.Client client) throws Exception {
        ...
        CreateSiteRequest createSiteRequest = new CreateSiteRequest()
                ...
                .setInstanceId(ratePlanInstCaaResponseBody.instanceId)
                .setCoverage("overseas")
                .setAccessType("NS");
    ...
    public static CreateRecordResponseBody record(CreateSiteResponseBody siteCaaResponseBody, com.aliyun.esa20240910.Client client) throws Exception {
        ...
        CreateRecordRequest createRecordRequest = new CreateRecordRequest()
                ...
                .setSiteId(siteCaaResponseBody.siteId)
                .setType("CAA")
                .setData(data)
                .setTtl(100);
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Init resource
        PurchaseRatePlanResponseBody ratePlanInstCaaRespBody = Sample.ratePlanInstCaa(esa20240910Client);
        CreateSiteResponseBody siteCaaRespBody = Sample.siteCaa(ratePlanInstCaaRespBody, esa20240910Client);
        CreateRecordResponseBody recordRespBody = Sample.record(siteCaaRespBody, esa20240910Client);
        // update resource
