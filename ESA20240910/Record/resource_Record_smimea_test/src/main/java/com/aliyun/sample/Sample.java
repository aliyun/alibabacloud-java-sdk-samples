...
public class Sample {
    ...
    public static PurchaseRatePlanResponseBody ratePlanInstSmimea(com.aliyun.esa20240910.Client client) throws Exception {
    ...
    public static CreateSiteResponseBody siteSmimea(PurchaseRatePlanResponseBody ratePlanInstSmimeaResponseBody, com.aliyun.esa20240910.Client client) throws Exception {
        ...
        CreateSiteRequest createSiteRequest = new CreateSiteRequest()
                ...
                .setInstanceId(ratePlanInstSmimeaResponseBody.instanceId)
                .setCoverage("overseas")
                .setAccessType("NS");
    ...
    public static CreateRecordResponseBody recordSmimea(CreateSiteResponseBody siteSmimeaResponseBody, com.aliyun.esa20240910.Client client) throws Exception {
    ...
    public static void updateRecordSmimea(CreateRecordResponseBody createRecordResponseBody, com.aliyun.esa20240910.Client client) throws Exception {
        ...
        UpdateRecordRequest.UpdateRecordRequestData data = new UpdateRecordRequest.UpdateRecordRequestData()
                .setUsage(3)
                .setMatchingType(3)
                .setCertificate("7737246264656475536f6d617256")
                .setSelector(3);
    ...
    public static void destroyRecordSmimea(CreateRecordResponseBody createRecordResponseBody, com.aliyun.esa20240910.Client client) throws Exception {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Init resource
        PurchaseRatePlanResponseBody ratePlanInstSmimeaRespBody = Sample.ratePlanInstSmimea(esa20240910Client);
        CreateSiteResponseBody siteSmimeaRespBody = Sample.siteSmimea(ratePlanInstSmimeaRespBody, esa20240910Client);
        CreateRecordResponseBody recordSmimeaRespBody = Sample.recordSmimea(siteSmimeaRespBody, esa20240910Client);
        // update resource
        Sample.updateRecordSmimea(recordSmimeaRespBody, esa20240910Client);
        // destroy resource
        Sample.destroyRecordSmimea(recordSmimeaRespBody, esa20240910Client);
    }
}
