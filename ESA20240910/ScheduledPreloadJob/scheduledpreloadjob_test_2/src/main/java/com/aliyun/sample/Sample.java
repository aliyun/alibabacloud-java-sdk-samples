...
public class Sample {
    ...
    public static CreateScheduledPreloadJobResponseBody schedPreloadJob(CreateSiteResponseBody siteResponseBody, com.aliyun.esa20240910.Client client) throws Exception {
        System.out.println("Begin Call CreateScheduledPreloadJob to create resource");
        CreateScheduledPreloadJobRequest createScheduledPreloadJobRequest = new CreateScheduledPreloadJobRequest()
                .setInsertWay("textBox")
                .setSiteId(siteResponseBody.siteId)
                .setUrlList("http://test1.gositecdn.cn/test/test.txt")
                .setName("testscheduledpreloadjob");
        CreateScheduledPreloadJobResponse createScheduledPreloadJobResponse = client.createScheduledPreloadJob(createScheduledPreloadJobRequest);
        System.out.println("Call CreateScheduledPreloadJob success, response: ");
        System.out.println(com.aliyun.teautil.Common.toJSONString(createScheduledPreloadJobResponse));
        return createScheduledPreloadJobResponse.body;
    }

    public static void destroySchedPreloadJob(CreateScheduledPreloadJobResponseBody createScheduledPreloadJobResponseBody, com.aliyun.esa20240910.Client client) throws Exception {
        System.out.println("Begin Call DeleteScheduledPreloadJob to destroy resource");
        DeleteScheduledPreloadJobRequest deleteScheduledPreloadJobRequest = new DeleteScheduledPreloadJobRequest()
                .setId(createScheduledPreloadJobResponseBody.id);
        DeleteScheduledPreloadJobResponse deleteScheduledPreloadJobResponse = client.deleteScheduledPreloadJob(deleteScheduledPreloadJobRequest);
        System.out.println("Call DeleteScheduledPreloadJob success, response: ");
        System.out.println(com.aliyun.teautil.Common.toJSONString(deleteScheduledPreloadJobResponse));
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        // destroy resource
        Sample.destroySchedPreloadJob(schedPreloadJobRespBody, esa20240910Client);
    }
}
